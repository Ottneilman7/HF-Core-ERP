...
export default function SalesPage() {
  ...
  const [newSaleOpen, setNewSaleOpen] = useState(true);
  ...
  return (
    <div style={{ maxWidth: "720px" }}>
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"8px" }}>
        <h1 style={{ color: colors.text, margin: 0 }}>Ventas</h1>
        <FormButton type="button" onClick={() => setShowNewCustomer(!showNewCustomer)}>
      ...
      <section style={{ ...sectionStyle, padding: 0, overflow: "hidden" }}>
        <button onClick={() => setNewSaleOpen(!newSaleOpen)} style={{ width:"100%", textAlign:"left", background:"none", border:"none", padding:"20px 24px", cursor:"pointer", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <h2 style={{ color: colors.text, margin: 0 }}>Nueva venta</h2>
          <span style={{ color: colors.textMuted, fontSize:"20px" }}>{newSaleOpen?"▲":"▼"}</span>
        </button>
        {newSaleOpen && <div style={{ padding: "0 24px 24px" }}>
      ...
      <section style={{ ...sectionStyle, padding: 0, overflow: "hidden" }}>
        <button onClick={() => setSalesListOpen(!salesListOpen)} style={{ width:"100%", textAlign:"left", background:"none", border:"none", padding:"20px 24px", cursor:"pointer", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <h2 style={{ color: colors.text, margin: 0 }}>Ventas registradas ({sales.length})</h2>
          <span style={{ color: colors.textMuted, fontSize:"20px" }}>{salesListOpen?"▲":"▼"}</span>
        </button>
        {salesListOpen && <div style={{ padding: "0 24px 24px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
          <span style={{ color: colors.textMuted, fontSize: "13px" }}>{sales.length} ventas</span>
